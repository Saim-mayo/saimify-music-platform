...
const { playlistIdParamValidator } = require('../validators/playlist.validator');
...
router.get('/songs', authMiddleware, requireAdmin, adminController.getAdminSongs);
router.get('/albums', authMiddleware, requireAdmin, adminController.getAdminAlbums);
router.get('/playlists', authMiddleware, requireAdmin, adminController.getAdminPlaylists);
...
router.delete('/playlists/:playlistId', authMiddleware, requireAdmin, playlistIdParamValidator, validate, adminController.deleteAdminPlaylist);
 ...
 *   patch:
 *     summary: Cancel a user's Stripe subscription (admin only)
 *     tags: [Admin]
 *     security: [{ cookieAuth: [] }, { bearerAuth: [] }]
 *     parameters:
 *       - in: path
 ...
 */
router.patch('/users/:userId/subscription/cancel', authMiddleware, requireAdmin, adminController.cancelUserSubscription);
