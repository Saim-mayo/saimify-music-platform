 ...
 * /auth/oauth/exchange:
 *   post:
 *     summary: Exchange a one-time Google OAuth code for auth cookies
 *     tags: [Auth]
 *     requestBody:
 *       required: true
 *       content:
 ...
 *               code:
 *                 type: string
 *                 description: One-time OAuth exchange code from the frontend callback route
 *     responses:
 *       200:
 *         description: Exchange succeeded and auth cookies are set
 *       400:
