...
// 🎵 CREATE SONG SERVICE
// =====================================
const createSongService = async ({ title, file, userId, cover, status = 'active', visibility = 'public', premiumOnly = false, allowDownload = true }) => {
...
// 💿 CREATE ALBUM
// =====================================
const createAlbumService = async ({ title, musics, userId, cover, status = 'active', visibility = 'public' }) => {
...
const getAlbumByIdService = async (albumId) => {
   ...
   const album = await albumModel.findById(albumId)
      .populate('artist', 'username avatar')
      .populate('musics', 'title playCount coverUrl');
