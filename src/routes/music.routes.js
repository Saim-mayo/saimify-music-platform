 ...
 * /music/play/{songId}:
 *   post:
 *     summary: Register a play (increments play count, adds to history, subject to daily play limit on the free plan)
 *     tags: [Music]
 ...
 *       403: { description: Daily play limit reached, or account banned }
 ...
 *       404: { description: Song not found }
 *       416: { description: Range header missing or not satisfiable }
 */
router.get(
   '/stream/:songId',
   streamLimiter,
